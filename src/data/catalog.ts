...
const coreVinyls: Vinyl[] = [
  createVinyl({
    ...
    description:
      "검정치마 정규 1집의 첫 바이닐 발매. 180g 레드 글리터 컬러 디스크와 팁온 게이트폴드 자켓으로 구성됩니다.",
  ...
  createVinyl({
    ...
    marketPrice: 200000,
    lowestPrice: 170000,
    releaseWindow: "2024.05.01 발매 · 최근 공개 체결가 확인 가능",
    description: "C Jamm의 정규 앨범 킁을 담은 180g 블랙 바이닐 판본입니다.",
    tracks: keungTracks,
    usedListings: [
      marketplaceListing(
        "joongna-keung-black-opened",
        89000,
        "NM",
        "VG+",
        "NM",
    ...
    marketReferences: [marketReference("최근 공개 체결가", 200000, "https://kream.co.kr/products/283464")],
  ...
  createVinyl({
    ...
    marketReferences: [marketReference("최근 공개 체결가", 300000, "https://kream.co.kr/products/283463")],
